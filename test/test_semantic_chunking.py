...
from src.simple_embeddings_module.chunking.mod_chunking_ts import (
    _get_code_line_breaks,
    ts_get_code_chunks,
)
...
def test_semantic_chunking():
    ...
    print("=" * 60)
    test_cases = [("test.py", PYTHON_CODE), ("test.js", JAVASCRIPT_CODE), ("test.rs", RUST_CODE)]
    ...
    for file_path in test_files:
        if os.path.exists(file_path):
            ...
            if sizes:
                ...
                if VERBOSE:
                    print("  Detailed size distribution:")
