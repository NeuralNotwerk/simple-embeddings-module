...
class StorageBackendBase(ABC):
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        ...
        base_capabilities = {
            ...
            "supports_partial_updates": getattr(
                self, "supports_partial_updates", False
            ),
            "supports_concurrent_access": getattr(
                self, "supports_concurrent_access", False
            ),
    ...
    def prepare_metadata(
        self, metadata: Dict[str, Any], vectors: torch.Tensor
    ) -> Dict[str, Any]:
        ...
        prepared.update(
            {
                ...
                "updated_at": now,
                "embedding_dim": (
                    vectors.shape[1] if len(vectors.shape) > 1 else vectors.shape[0]
                ),
